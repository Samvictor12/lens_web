...
const MODULE_KEYS = [
  ...
  'expenses', 'income', 'bank_accounts', 'customer_payments', 'vendor_payments',
  'bank_reconciliation', 'financial_reports',
  'reports', 'business_categories', 'expense_categories', 'income_categories', 'customers',
...
async function main() {
  ...
  const accountsPermissions = [
    ...
    { mod: 'income', acts: ['Screen', 'Create', 'Edit', 'View', 'Delete'] },
    { mod: 'bank_accounts', acts: ['Screen', 'Create', 'Edit', 'View', 'Delete'] },
    { mod: 'expense_categories', acts: ['Screen', 'Create', 'Edit', 'View', 'Delete'] },
    { mod: 'income_categories', acts: ['Screen', 'Create', 'Edit', 'View', 'Delete'] },
