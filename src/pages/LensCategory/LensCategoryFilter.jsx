...
export default function LensCategoryFilter({
  filters,
  tempFilters,
  setTempFilters,
  showFilterDialog,
    ...
    <>
      ...
      <Dialog open={showFilterDialog} onOpenChange={setShowFilterDialog}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle className="text-lg">Filter Lens Categories</DialogTitle>
            <DialogDescription className="text-xs">
              Apply filters to refine your lens category list
            </DialogDescription>
          </DialogHeader>
