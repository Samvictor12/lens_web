...
import { expenseTypeOptions } from "./ExpenseCategory.constants";
...
export default function ExpenseCategoryFilter({
  ...
  const classificationOptions = [
    { id: "all", name: "All" },
    ...expenseTypeOptions.map((opt) => ({ id: opt.value, name: opt.label })),
  ];
  ...
  return (
    <div className="flex items-center gap-1.5">
      <Sheet open={showFilterDialog} onOpenChange={setShowFilterDialog}>
        ...
        <SheetContent>
          <SheetHeader>
            <SheetTitle>Filter Expense Categories</SheetTitle>
            <SheetDescription>
