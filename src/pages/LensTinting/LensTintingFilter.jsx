...
export default function LensTintingFilter({
  filters,
  tempFilters,
  setTempFilters,
  showFilterDialog,
    ...
    <>
      ...
      <Dialog open={showFilterDialog} onOpenChange={setShowFilterDialog}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle className="text-lg">Filter Lens Tintings</DialogTitle>
            <DialogDescription className="text-xs">
              Apply filters to refine your lens tinting list
            </DialogDescription>
          </DialogHeader>
