...
export default function LensIndexFilter({
  filters,
  tempFilters,
  setTempFilters,
  showFilterDialog,
  ...
  return (
    <div className="flex items-center gap-1.5">
      <Sheet open={showFilterDialog} onOpenChange={setShowFilterDialog}>
        ...
        <SheetContent>
          <SheetHeader>
            <SheetTitle>Filter Lens Indexes</SheetTitle>
            <SheetDescription>
              Apply filters to refine your lens index list
            </SheetDescription>
          </SheetHeader>
          ...
          <SheetFooter className="flex flex-row gap-2">
            <Button variant="outline" size="xs" onClick={onCancelFilters} className="flex-1">
              Cancel
            </Button>
      ...
      {hasActiveFilters && (
        <Button variant="ghost" size="xs" className="h-8 px-2" onClick={onClearFilters}>
