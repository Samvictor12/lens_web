...
function formatPermissions(dbPermissions) {
  ...
  const CATALOG_TEMPLATES = [
    ...
    { key: 'income', label: 'Income', actions: { Screen: false, Create: false, Edit: false, View: false, Delete: false } },
    { key: 'bank_accounts', label: 'Bank Accounts', actions: { Screen: false, Create: false, Edit: false, View: false, Delete: false } },
    ...
    { key: 'income_categories', label: 'Income Categories', actions: { Screen: false, Create: false, Edit: false, View: false, Delete: false } },
