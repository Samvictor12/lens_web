...
import lensIndexRoutes from './routes/lensIndexes.routes.js';
...
import locationTrayMasterRoutes from './routes/locationTrayMaster.routes.js';
import lensTintingRoutes from './routes/lensTintings.routes.js';
import lensOffersRoutes from './routes/lensOffers.routes.js';
...
import incomeCategoryRoutes from './routes/incomeCategory.routes.js';
...
import vendorIndirectExpenseRoutes from './routes/vendorIndirectExpense.routes.js';
...
app.use('/api/v1/lens-indexes', lensIndexRoutes);
...
app.use('/api/v1/location-tray-master', locationTrayMasterRoutes);
app.use('/api/v1/lens-tintings', lensTintingRoutes);
app.use('/api/v1/lens-offers', lensOffersRoutes);
...
app.use('/api/vendor-indirect-expenses', vendorIndirectExpenseRoutes);
