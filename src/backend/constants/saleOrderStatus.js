...
/** Fitting operator list */
export const FITTING_QUEUE_STATUSES = ['FITTING_READY', 'IN_FITTING', 'ON_HOLD'];
...
export const ALLOWED_TRANSITIONS = {
  ...
  PRE_QC: ['FITTING_READY', 'PRE_QC_REJECTED', 'PRE_QC_SCRAPPED'],
  PRE_QC_REJECTED: ['DRAFT'],
  PRE_QC_SCRAPPED: ['DRAFT'],
  FITTING_READY: ['IN_FITTING', 'ON_HOLD', 'AWAITING_QUALITY'],
  IN_FITTING: ['ON_HOLD', 'AWAITING_QUALITY'],
  ON_HOLD: ['AWAITING_QUALITY'],
