...
export const PERMISSION_CATALOG = [
  ...
  perm('income', 'Income', { ...CRUD }),
  perm('bank_accounts', 'Bank Accounts', { ...CRUD }),
  perm('vendor_payments', 'Vendor Payments', { ...CRUD }),
  perm('customer_payments', 'Customer Payments', { ...CRUD }),
  ...
  perm('income_categories', 'Income Categories', { ...CRUD }),
