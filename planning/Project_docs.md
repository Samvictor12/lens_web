...
|----|-------|--------|---------------|---------------|
| inventory-module-flow-gaps | Close gaps in Product Inward, Dashboard analytics, and Stock Summary | **Pass A DONE / Pass B pending** | `planning/features/inventory-module-flow-gaps.md` | 2026-06-26 |
