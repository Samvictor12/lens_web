...
**Seeded groups (19):** Assets â†’ Current Assets â†’ Cash-in-Hand, Bank Accounts, Sundry Debtors, Inventory, GST Input; Liabilities â†’ Current Liabilities â†’ Sundry Creditors, GST Output, TDS; Capital; Income/Expense Direct & Indirect sub-groups.
...
- `Invoice` — billed from Sale Orders; `dueDate` from `Customer.credit_days`; statuses include ISSUED / PARTIALLY_PAID / PAID / CANCELLED.
